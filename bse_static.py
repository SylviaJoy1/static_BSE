...
class BSE(rhf.TDA):
    ...
    def __init__(self, mf, df_file, tdmf, gw_e, frozen=None, TDA=True, singlet=True, mo_coeff=None, mo_occ=None):
...
if __name__ == '__main__':
    ...
    bse = BSE(mf, formula+'.h5', td, gw_e, TDA=False, singlet=True)
